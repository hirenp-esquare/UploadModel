...
mv $INPUT_DESTINATION_FOLDER/cc_*.vmfx $INPUT_DESTINATION_FOLDER/CC_Temp_PROD.vmfx
mv $INPUT_DESTINATION_FOLDER/mm_*.vmfx $INPUT_DESTINATION_FOLDER/MM_Temp_PROD.vmfx
mv $INPUT_DESTINATION_FOLDER/psy_*.vmfx $INPUT_DESTINATION_FOLDER/Psy_Temp_PROD.vmfx
mv $INPUT_DESTINATION_FOLDER/agg_*.vmfx $INPUT_DESTINATION_FOLDER/Agg_Temp_PROD.vmfx
mv $INPUT_DESTINATION_FOLDER/sp_*.vmfx $INPUT_DESTINATION_FOLDER/SuicidePrevention_Temp_PROD.vmfx
