...
mv $INPUT_DESTINATION_FOLDER/cc_*-A.html $INPUT_DESTINATION_FOLDER/ccsdmdoc.html
mv $INPUT_DESTINATION_FOLDER/mm_*-A.html $INPUT_DESTINATION_FOLDER/mmsdmdoc.html
mv $INPUT_DESTINATION_FOLDER/psy_*-A.html $INPUT_DESTINATION_FOLDER/psysdmdoc.html
mv $INPUT_DESTINATION_FOLDER/agg_*-A.html $INPUT_DESTINATION_FOLDER/aggsdmdoc.html
mv $INPUT_DESTINATION_FOLDER/sp_*-A.html $INPUT_DESTINATION_FOLDER/spsdmdoc.html
